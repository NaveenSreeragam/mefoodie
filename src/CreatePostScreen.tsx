  ...
  if (posted) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#FFF9ED] px-4">
        ...
        <h2 className="font-display font-900 text-[#24221D] text-2xl text-center">Discovery Posted!</h2>
        <p className="text-[#8B8578] text-sm font-body mt-2 text-center">Your food discovery is live for the TVM community</p>
      </div>
    );
  }
  ...
  return (
    <div className="pb-28 screen-enter">
      ...
      <div className="px-4 pt-12 pb-4 flex items-center gap-4">
        <button onClick={onBack} className="w-10 h-10 rounded-full bg-white flex items-center justify-center" style={{ boxShadow: '0 2px 8px rgba(36,34,29,0.08)' }}>
      ...
      <div className="px-4 flex flex-col gap-4">
        ...
        {/* Restaurant */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-1.5">Restaurant *</label>
        ...
        {/* Food Item */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-1.5">Food Item *</label>
          <input
            type="text"
            value={foodItem}
        ...
        {/* Price */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-1.5">Price (₹)</label>
          <input
            type="number"
            value={price}
        ...
        {/* Rating */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-2">Your Rating *</label>
          ...
          {rating > 0 && (
            <p className="text-[#8B8578] text-xs font-body mt-1">
              {['', 'Not great', 'It was ok', 'Good!', 'Really good!', 'Absolutely amazing! 🤩'][rating]}
            </p>
          )}
        </div>
        ...
        {/* Review */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-1.5">Your Discovery Story</label>
          <textarea
            value={review}
        ...
        {/* Tags */}
        <div>
          <label className="block text-[#24221D] font-display font-700 text-sm mb-2">Tag this discovery</label>
            ...
            {postTags.map(tag => (
              <button
                ...
                style={{
                  ...
                  boxShadow: selectedTags.includes(tag.id) ? `0 2px 12px ${tag.textColor}40` : 'none',
                }}
              >
                {tag.label}
              </button>
        ...
        <button
          ...
          style={{ boxShadow: restaurant && foodItem && rating ? '0 6px 24px rgba(255,201,40,0.4)' : 'none' }}
        >
          POST DISCOVERY 🚀
        </button>
      </div>

    ...
    <div className="pb-28 screen-enter">
      ...
      <div className="px-4 pt-12 pb-4">
        <div className="flex items-start justify-between">
          ...
          <button
            className="w-11 h-11 rounded-full bg-white flex items-center justify-center relative mt-1"
            style={{ boxShadow: "0 2px 12px rgba(36,34,29,0.08)" }}
          >
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-3 px-4 overflow-x-auto pb-1">
          {foodCategories.map((cat) => (
            ...
            >
              <div
                className={`w-[68px] h-[68px] squircle-cat flex items-center justify-center text-2xl transition-all ${activeCategory === cat.id ? "bg-[#24221D] scale-105" : "bg-white"}`}
                style={{
                  boxShadow:
              ...
              <span
                className={`text-[11px] font-body font-500 text-center leading-tight max-w-[68px] ${activeCategory === cat.id ? "text-[#24221D] font-700" : "text-[#8B8578]"}`}
              >
                {cat.label}
              </span>
            </button>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between px-4 mb-3">
            ...
            <button
              ...
              className="text-[#FFC928] text-sm font-display font-700"
            >
              See all
            </button>
          </div>
      ...
      <div className="mb-6">
        <SectionHeader
          ...
          subtitle="Still open after midnight"
          onSeeAll={onExploreClick}
        />
        <div className="flex gap-3 px-4 overflow-x-auto pb-1">
          {lateNightItems.map((item, i) => (
            <FoodCard
              ...
              onClick={() =>
                onRestaurantClick(
                  restaurants.find((r) => r.name === item.restaurant)?.id ?? "shawarma-king",
                )
              }
            />
          ))}
      ...
      <div className="mb-6">
        <SectionHeader
          ...
          subtitle="Most-loved in Thiruvananthapuram"
          onSeeAll={onExploreClick}
        />
          ...
          {restaurants.slice(0, 3).map((r, i) => (
            ...
            >
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="bg-[#24221D] text-[#FFC928] text-xs font-display font-bold px-2 py-0.5 rounded-full">
                  ★ {r.rating}
                </span>
